  ...
  return (
    <Container className="scrollable-container">
      ...
      <Row className="d-flex flex-row col-md-12" style={{ marginBottom: "1%" }}>
        <label className="col-md-2 mt-3" htmlFor="user">
          <p>Question Difficulty</p>
        </label>
        <select
          name="Difficulty"
          className="question-diff-small col-md-2 mt-3"
        ...
        {list.length !== 0 ? (
            <Table className="table-bordered">
              ...
              list.map((obj, index) => <Row className="questions-rows col-md-12" key={obj.qid}>
                    <QuestionModal obj = {obj} allData={props.quesDetails} qid={obj.qid} addButton={0} />
              </Row>
              )
              }
              </tbody>
